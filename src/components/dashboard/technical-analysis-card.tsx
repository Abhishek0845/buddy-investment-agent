          ...
          <CardContent className="pt-4 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-3" role="list">
                ...
                {reasoning.length === 0 && (
                  <li className="text-xs text-muted-foreground italic">No technical reasoning summary available.</li>
                )}
              </ul>
            </div>
          </CardContent>
        ...
        <div className="mt-auto">
              ...
              <div className="border border-border rounded-xl overflow-hidden bg-muted/20">
                <Table>
                  <TableHeader className="bg-muted/40 border-border">
                    <TableRow>
                      <TableHead className="text-[10px] uppercase font-bold text-muted-foreground py-1.5 h-auto">Signal</TableHead>
          ...
          {onAskBuddy && (
            <div className="border-t border-border p-3 flex flex-wrap gap-1.5 items-center bg-card/30">
              ...
              <button
                onClick={() => handleAsk("Explain RSI indicator")}
              ...
              <button
                onClick={() => handleAsk("Explain Moving Average trends")}
                className="text-[9px] font-semibold px-2 py-0.5 rounded bg-card hover:bg-muted border border-border text-foreground hover:text-primary transition-all duration-150 cursor-pointer"
              >
                MA Trend
              </button>
              <button
                onClick={() => handleAsk("Explain Future price momentum and Technical Trend")}
                className="text-[9px] font-semibold px-2 py-0.5 rounded bg-card hover:bg-muted border border-border text-foreground hover:text-primary transition-all duration-150 cursor-pointer"
              >
                Future Trend
              </button>
